...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="assets/images//logo/icon-junko.png">
                    ...
                    <div class="row">
                        <div class="col col-md-7 col-sm-12 col-12">
                            <div class="contact-intro">
                                <ul>
                                    <li><i class="fi ti-location-pin"></i>TP. Đà Nẵng, Việt Nam</li>
                                    <li><i class="fi flaticon-email"></i> junkoyvg@gmail.com</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col col-md-5 col-sm-12 col-12">
                            <div class="contact-info">
                                <ul>
                                    <li>Cập nhật tin tức mới về JunkoYVG tại</li>
                            ...
                            <div class="col-lg-3 col-md-6 col-6">
                                <div class="navbar-header">
                                    <a class="navbar-brand" href="index.html"><img
                                            src="assets/images//logo/footage-junko.png" alt=""></a>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-2 col-2">
                                <div class="header-right">
                                    <div class="close-form">
                                        <a class="theme-btn-s2" href="donate.html">Quyên góp</a>
                                    </div>
                            ...
                            <div class="wpo-event-single">
                                <div class="wpo-event-item">
                                    ...
                                    <div class="wpo-event-content">
                                        <div class="wpo-event-text-top">
                                            <span>24 Nov, 2022</span>
                                            <h2><a href="event-single.html">Provideing Education Is The Valuable
                                                    Gift</a></h2>
                                            <p>There are many variations of passages of Lorem Ipsum available.</p>
                                        </div>
                                    </div>
                        ...
                        <div class="col col-lg-3 col-md-6 col-sm-12 col-12">
                            <div class="widget about-widget">
                                <div class="logo widget-title">
                                    <img src="assets/images/logo/footage-junko.png" alt="blog">
                                </div>
                                <p>Hiệp hội thanh niên tình nguyện Junko Đà Nẵng, Việt Nam</p>
                                <ul>
                                    <li>
                                        <a href="#">
                        ...
                        <div class="col col-lg-4 col-md-6 col-sm-12 col-12">
                            <div class="widget wpo-service-link-widget">
                                ...
                                <div class="contact-ft">
                                    ...
                                    <ul>
                                        <li><i class="fi flaticon-mail"></i>junkoyvg@gmail.com</li>
                                        <li><i class="fi flaticon-phone-call"></i>093 492 02 91 (Ms. Mẫn Nhi)</li>
                                        <li><i class="fi flaticon-location"></i>Đà Nẵng, Việt Nam</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col col-xs-12">
                            <p class="copyright"> &copy; 2022 JunkoYVG. </a>. All Rights Reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
